...
def material_equivalence_b2_b_algorithm(x1: BooleanValue, x2: BooleanValue) -> BooleanValue:
...
material_equivalence_b2_b = Function(d.b_2, d.b, material_equivalence_b2_b_algorithm, glyphs.logical_material_equivalence)


iif_b2_b = material_equivalence_b2_b
