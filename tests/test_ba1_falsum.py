...
class TestBA1Falsum(TestCase):

    def test_ba1_falsum(self):
        self.assertEqual('⊥', str(naive.BA1.falsum))

        # Falsum is a 0-ary function, test it as a formula.
        psi1 = naive.f(naive.BA1.falsum)
        print(psi1)
